...
public class KonopolisController {
     ...
     * @param show_start
     */
	public synchronized void addCustomer(int x, int y,int room_id, String type, int movie_id, LocalDateTime show_start) {
    ...
    public synchronized String dateInFrench(LocalDateTime date) {
        ...
        String[] months = {"Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "AoÃ»t", "Septembre", "Octobre", "Novembre", "Décembre"};
